...
def kupiec_pof(cap, conf=CONF):
    ...
    if pi in (0.0, 1.0):
        ...
        lr = -2 * ((x * math.log(pe) + (n - x) * math.log(1 - pe))
...
def christoffersen_ind(cap):
    ...
    lla = (n00 * math.log(1 - p01 + 1e-12) + n01 * math.log(p01 + 1e-12)
           + n10 * math.log(1 - p11 + 1e-12) + n11 * math.log(p11 + 1e-12))
    lr = -2 * (lln - lla)
